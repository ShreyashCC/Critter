...
public class PetController {
    ...
    public PetDTO getPet(@PathVariable long petId) {
        ...
        try {
            ...
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Pet with id: " + petId + " not found", exception);
        }
    ...
    public List<PetDTO> getPetsByOwner(@PathVariable long ownerId) {
        ...
        try {
            ...
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Pets for owner with id " + ownerId + " not found", exception);
        }
        return pets.stream().map(this::convertPetToPetDTO).collect(Collectors.toList());
    }
}
